...
from utils import Case, creer_matrice
...
class Echiquier:
    ...
    def __init__(self, dimension: int, case_de_depart: Case):
        ...
        self.case_de_depart = case_de_depart
        self.reset()

    def reset(self) -> None:
        """Remettre l'échiquier dans son état initial
        """
        self.__matrice = creer_matrice(self.dimension)
    ...
    def prometteur(self, case: Case) -> bool:
        ...
        """
        _x, _y = case
        return 0 <= _x < self.dimension and 0 <= _y < self.dimension and not self.is_taken(case)
